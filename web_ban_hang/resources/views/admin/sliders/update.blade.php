                                    ...
                                    <form action="{{ route('admin.sliders.update', $slider->id) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group mb-3">
                                                ...
                                                @if ($slider->image)
                                                    <img src="{{ asset('storage/' . $slider->image) }}" alt="Current Image" class="mt-2" style="max-width: 200px;">
                                                @endif
                                            </div>
                                
                                            <div class="form-group">
                                                <label for="offer">Offer</label>
                                                <input type="text" name="offer" id="offer" class="form-control" value="{{ old('offer', $slider->offer) }}">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="status" id="status" class="form-control">
                                                    ...
                                                    <option value="1" {{ old('status', $slider->status) == '1' ? 'selected' : '' }}>Show</option>
                                                    <option value="0" {{ old('status', $slider->status) == '0' ? 'selected' : '' }}>Hidden</option>
                                                </select>
                                            </div>
                                        </div>
