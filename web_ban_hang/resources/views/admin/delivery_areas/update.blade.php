...
@section('title')
    Cập Nhật Địa Chỉ Giao Hàng - Pizzato
@endsection
                ...
                <div class="col-xl-12 col-xxl-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Cập Nhật Địa Chỉ Giao Hàng</h4>
                        </div>
                        <div class="card-body">
                            <div class="basic-form">
                                <form action="{{ route('admin.delivery_areas.update', $area->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <a href="{{ route('admin.delivery_areas.index') }}" class="btn btn-secondary">
                                        Quay Lại</a>
